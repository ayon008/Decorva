    ...
    useGSAP(() => {
        ...
        if (isOpen) {
            ...
            gsap.to(sideCartRef.current, {
                ...
                duration: 0.3,
                ease: 'power2.in',
                onComplete: () => setShouldRender(false) // Add this
            });
        }
    }, { dependencies: [isOpen, shouldRender] }); // Add shouldRender to dependencies
            ...
            >
                <div className=''>
                    <div className='p-5 flex items-center justify-between gap-[10px] flex-wrap  border-b border-b-[#E6E6E6]'>
                        <span className={`text-[#111] text-[20px] font-bold uppercase ${lora.className}`}>Your cart</span>
